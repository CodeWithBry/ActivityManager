...
function LogIn() {
            ...
            try {
                ...
                if (error instanceof FirebaseError) {
                    ...
                    if (emailRef.current && passwordRef.current) {
                        emailRef.current.innerText = "Username may not be correct"
    ...
    useEffect(() => {
        if (userObject == null) { pageDetector(0, null, true) }
        else pageDetector(null, 0, true)
    }, []);
                    ...
                    <label
                        ...
                        <input
                            ...
                            onChange={(e) => {
                                ...
                                emailRef.current ? emailRef.current.innerText = "" : null
                            }}
                        />
                        <span className={email ? s.focused : s.unfocus}>Email</span>
                        <i
                            className={hideEmail == true ? `${s.eyeIcon} "fa fa-eye"` : `${s.slashEye} "fa fa-eye-slash"`}
                            onClick={() => {
                                setHideEmail(hideEmail ? false : true)
                            }}
                        ></i>
                    </label>
                    ...
                    <label
                        ...
                        <input
                            ...
                            onChange={(e) => {
                                ...
                                passwordRef.current ? passwordRef.current.innerText = "" : null
                            }} />
